# Kalshi Temperature Model v19.1
# - Fixed Miami brackets to match today's ladder
# - Added spread safety valve for trajectory adjustment
...
st.set_page_config(page_title='Kalshi Temperature Model v19.1', layout='wide')
st.title('Kalshi Temperature Model v19.1')
...
KALSHI_BRACKETS = {
    ...
    'Atlanta': [('74 or below', None, 74), ('75 to 76', 75, 76), ('77 to 78', 77, 78), ('79 to 80', 79, 80), ('81 to 82', 81, 82), ('83 or above', 83, None)],
    'NYC': [('62 or below', None, 62), ('63 to 64', 63, 64), ('65 to 66', 65, 66), ('67 to 68', 67, 68), ('69 to 70', 69, 70), ('71 or above', 71, None)],
    'Miami': [('79 or below', None, 79), ('80 to 81', 80, 81), ('82 to 83', 82, 83), ('84 to 85', 84, 85), ('86 to 87', 86, 87), ('88 or above', 88, None)],
}
...
st.caption('Model v19.1 â Miami fix + spread safety valve + fixed Kalshi brackets')
