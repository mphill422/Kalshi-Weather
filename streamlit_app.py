...
st.set_page_config(page_title="Kalshi Temperature Model v11.1")

st.title("Kalshi Temperature Model v11.1")
...
df_sources=pd.DataFrame(source_table,columns=["Source","High","Status"])
...
if current:
    st.write("Current Temperature:",current)
